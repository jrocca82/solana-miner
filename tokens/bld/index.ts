...
const TOKEN_NAME = "BARYCAPA";
const TOKEN_SYMBOL = "BCPY";
const TOKEN_DESCRIPTION = "A token for buildoors";
const TOKEN_IMAGE_NAME = "barycapa.jpg"; // Replace unicorn.png with your image name
...
async function createBldToken(
    ...
    console.log("connected to metaplex")
